...
public abstract class BaseException extends RuntimeException {
	...
	public static final int CUSTOMER_UPDATE_NULL_ARGUMENT_CODE = BASE_CODE + 7;
	public static final int CUSTOMER_UPDATE_NULL_ROLE_CODE = BASE_CODE + 8;
	public static final int CUSTOMER_UPDATE_NULL_ROLE_ID_CODE = BASE_CODE + 9;
	public static final int ACCOUNT_ID_REQUIRED_CODE = BASE_CODE + 10;
	public static final int ACCOUNT_NOT_FOUND_CODE = BASE_CODE + 11;
	public static final int CUSTOMER_OF_ACCOUNT_NOT_FOUND = BASE_CODE + 12;
	public static final int CURRENCY_OF_ACCOUNT_NOT_FOUND = BASE_CODE + 13;
